#!/usr/bin/env python3
"""Fetch SMM 1#电解镍 spot price. Primary: AKShare; Fallback: SMM AJAX API.
...
# ========== Fallback: SMM AJAX API ==========
if result["source"] == "default":
    SMM_PRODUCT_ID = "201102250330"  # 1#电解镍
    ...
    try:
        ...
        with urllib.request.urlopen(req, timeout=15) as resp:
            ...
            if smm.get("code") == 0 and smm.get("data"):
                ...
                if avg > 0:
                    result["price"] = int(avg)
                    result["source"] = "smm_ajax"
                    result["renew_date"] = latest.get("renew_date", "")
